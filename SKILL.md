---
name: web-review
description: Open a local GitHub-style review of the current changes in the browser, show the human the URL, wait for their line-anchored comments, and act on them. Use after finishing a batch of edits, when the user asks to review changes, or before committing or pushing.
---
